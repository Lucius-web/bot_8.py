...
async def start(message: Message):
    await message.answer(f'Приветствую вас {message.from_user.first_name}!\nЯ ваш бот проводник, если хотите узнать какую либо информацию то она имеется у вас в области клавиатуры и удачи в познании мира программирования!', reply_markup=types.main)
...
async def direction(message: Message):
    await message.answer('У нас имеются 3 направление по кнопкам ниже', reply_markup=types.setting)
